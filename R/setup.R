...
setup <- function(load = TRUE){
  pkg<-c("MASS","pwr", "ISLR", "plm", "stargazer", "nlme", "pwrAB","scales","ggplot2", "plot3D", "margins", "forecast", "lift","StatMeasures","e1071","OOR","rgenoud","fitdistrplus","fastDummies", "alabama", "sn", "ramify", "readxl","tidyverse", "tprstats")
