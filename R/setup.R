...
setup <- function(load = TRUE) {
  pkg <- c("EnvStats", "MASS", "pwr", "stargazer", "pwrAB", "ggplot2", "plot3D", "margins", "forecast", "lift", "StatMeasures", "e1071", "rgenoud", "fitdistrplus", "fastDummies", "alabama", "sn", "ramify", "car", "readxl", "tidyverse", "tprstats")
